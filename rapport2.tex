...
Nous avons choisi à calculé $\left(-\frac{\text{d}\,E}{\text{d}\,x}\right)$ avec la methode suivante: Nous avons calculé la pente entre deux couple de valeurs se succédant. Aprés en a ordonné ces valeurs d'abord vers la distance et puis vers l'énergie. Pour l'\isotope[241]{Am} en observe un pic juste avant que les particules ne s'arrêtent. On appelle ce phénomène le pic de Bragg. Pour la deuxième courbe on trouve que le pic est placé au début de la courbe ou les particules $\alpha$ ont seulement peu énegie, 	 cela vient de ce que quand les particules son lentes, elles passent davantage de temps dans un atome et donc la section efficace d'interaction augmente.\\
Pour le l'\isotope[212]{Bi} on ne trouve pas un joli pic pars que le rayon d'action de l'\isotope[212]{Bi} est plus grand que le distance maximale dans notre manip à cause d'énergie plus grande des particules $\alpha$. C'est vrai d'autant plus pour le Po pars que l'énergie cinetique des particules $\alpha$ est encore plus grande.
  \begin{figure}[H]
   \begin{minipage}{0.45\textwidth}
    \includegraphics[width=\textwidth]{Bilder/picAm.png}
    \caption{Pic de Bragg mesuré pour l' \isotope[241][95]{Am} en fonction de la distance}
   \end{minipage}
   \hfill
   \begin{minipage}{0.45\textwidth}
    \includegraphics[width=\textwidth]{Bilder/picAm2.png}
    \caption{Pic de Bragg mesuré pour l' \isotope[241][95]{Am} en fonction de l'énergie}
   \end{minipage}
  \end{figure}
  \begin{figure}[H]
   \begin{center}
    \includegraphics[width=0.45\textwidth]{Bilder/picBi.png}
   \end{center}
   \caption{Pic de Bragg mesuré pour le \isotope[212][83]{Bi}}
  \end{figure} 
 \end{section}
