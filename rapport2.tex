  ...
  \begin{subsection}{La source \isotope[241][95]{Am}}
   ...
   se fait par fission spontanée.  
    \begin{figure*}[hbt]
     ...
     \end{center}
     \caption{schéma de désintegration de l'\isotope[241][95]{Am}}
    \end{figure*}
...
Q=T(Np)+T(\alpha)
  \end{equation*}
On trouve donc pour les énergies cinétiques du \isotope[4][2]{He}   
\begin{equation*}
...
\begin{figure*}[hbt]
     ...
     \end{center}
     \caption{schéma de désintégration du \isotope[212]{84}{P0} }
    \end{figure*}
...
\begin{table}[htbp]
\caption{energie d'alpha en fonction de pression pour \isotope[241][95]{Am}}
\begin{center}
...
\end{table}
\begin{table}[htbp]
\caption{energie d'alpha en fonction de pression pour \isotope[212][83]{Bi}}
\begin{center}
\begin{tabular}{|c||c|c|c|c|c|c|c|}
\hline 
pression\unit{[mb]} & pic	&	énergie	&	err(én)	&	resolution	&	err(res)	&	$n^{\circ}$ de particules	&	err(part) 	\\ \hline\hline
