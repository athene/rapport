 ...
 \begin{section}{Pic de Bragg}
  ...
  \begin{figure}[H]
   \begin{minipage}{0.45\textwidth}
    ...
    \caption{Pic de Bragg mesuré pour le \isotope[241][95]{Am}}
   \end{minipage}
   \hfill
   \begin{minipage}{0.45\textwidth}
  ...
  \begin{figure}[H]
   ...
   \end{center}
   \caption{Pic de Bragg mesuré pour le \isotope[212][82]{Po}}
  \end{figure}
  On voit que nous serions besoin de plus des dates pour obtenir des meilleures courbes, spécialement pour la courbe du \isotope[212][82]{Po}. 
 \end{section}
