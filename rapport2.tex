...
\enlargethispage{1cm}
 ...
 \begin{subsection}{La source \isotope[241][95]{Am}}
   ...
   \begin{subsection}{La source \isotope[212][82]{Po}}
    Les résultats sont de la même mesure que les résultats du \isotope[212][83]{Bi} avec $t=\unit[30]{s}$ et $U=\unit[80]{V}$. Le tableau \ref{tabelle-po} des dates se trouve à la page \pageref{tabelle-po}.\\
   \begin{minipage}{0.45\textwidth}
 ...
 \begin{subsection}{La source \isotope[241][95]{Am}}
  \begin{figure}[H]
   \begin{minipage}{0.45\textwidth}
    ...
    \caption{Pic de Bragg mesuré de l' \isotope[241][95]{Am} en fonction de la distance}
   \end{minipage}
   \hfill
   \begin{minipage}{0.45\textwidth}
    \includegraphics[width=\textwidth]{Bilder/picAm2.png}
    \caption{Pic de Bragg mesuré de l' \isotope[241][95]{Am} en fonction de l'énergie}
   \end{minipage}
  \end{figure}
  Pour l'\isotope[241]{Am} on observe un pic juste devant l'arrêt pour la courbe en fonction de la distance et pour l'autre courbe on trouve un pic placé au début de la courbe où les particules $\alpha$ ont seulement peu d'énegie. On appelle cette pic le pic de Bragg. Il s'explique par l'idée qu'une particule lente passe plus de temps dans un atome et donc la section efficace d'interaction augmente.
 \end{subsection}
  ...
  \begin{figure}[H]
   \begin{minipage}{0.45\textwidth}
    ...
    \caption{Pic de Bragg mesuré de l' \isotope[212][83]{Bi} en fonction de la distance}
   \end{minipage}
   \hfill
   \begin{minipage}{0.45\textwidth}
    \includegraphics[width=\textwidth]{Sabine/bipic2.png}
    \caption{Pic de Bragg mesuré de l' \isotope[212][83]{Bi} en fonction de l'énergie}
   \end{minipage}
  \end{figure}
  Pour le \isotope[212]{Bi} on voit aussi un pic, mais il n'est pas très bien tracé parce que le rayon d'action de le \isotope[212]{Bi} est le même que la distance maximale dans notre dispositif experimental, comme nous avons vu dans la calculation du logiciel \glqq Astar\grqq. En plus nous n'avons pas eu de temps pour mesurer encore plus précise devant et après le trajet maximale des particules. 
 \end{subsection}
\enlargethispage{1,5cm}
 \begin{subsection}{La source \isotope[212][82]{Po}}
  \begin{figure}[H]
   ...
   \end{center}
   \caption{Mesure du \isotope[212][82]{Po}}
  \end{figure} 

   Ici on ne voit pas de pic parce que le trajet des particules $\alpha$ du \isotope[212]{Po} est le double de la distance maximale de notre dispositif expérimental, parce que l'énergie cinétique des particules $\alpha$ est encore plus grande. Ainsi nous n'avons pas eu la possibilité de mesurer le pic de Bragg pour le \isotope[212]{Po}. 
  \end{subsection}
  ...
  \begin{section}{Tableaux}
   ...
   \begin{table}[H]
    \begin{center}
     \begin{tabular}{c|c|c|c|c}
      ...
      0				&0 	&14			&836,5	&38,455\\
     \end{tabular}
    \caption{\label{tabelle-am} Les résultats du \isotope[241][95]{Am} }
    \end{center}
   \end{table}
   ...
   \begin{table}[H]
    \begin{center}
     \begin{tabular}{c|c|c|c|c}
      ...
      0				&0			&25			&905,2	&40,953
     \end{tabular}
    \caption{\label{tabelle-bi} Les résultats du \isotope[212][83]{Bi} }
    \end{center}
   \end{table}
   ...
   \begin{table}[H]
    \begin{center}
     ...
     \end{tabular}
    \caption{\label{tabelle-po}Les résultats du \isotope[212][82]{Po}}
    \end{center}
   \end{table}
  \end{section}
 \end{appendix}
